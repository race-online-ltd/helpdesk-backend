...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'oracle' => [
            'driver'         => 'oracle',
            'host'           => env('ORACLE_HOST', '172.10.7.94'),
        ...
        'maxim' => [
            'driver'         => 'oracle',
            'tns'            => env('MAXIM_TNS', ''),
            'host'           => env('MAXIM_HOST', '172.17.8.232'),
            'port'           => env('MAXIM_PORT', '1521'),
            'database'       => env('MAXIM_DATABASE', 'maximdb'),
            'username'       => env('MAXIM_USERNAME', 'erpview'),
            'password'       => env('MAXIM_PASSWORD', 'qnd6ybe7dqdew'),
